...
public class SetTransformableDialog extends SelectionDialog {
	...
	public SetTransformableDialog(Shell parentShell) {
		super(parentShell);
		setTitle(TITLE);
		transformables.addAll(TransformationUtil.getAllTransformables());
	}
