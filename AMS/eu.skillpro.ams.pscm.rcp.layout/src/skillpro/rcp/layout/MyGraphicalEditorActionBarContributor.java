...
import skillpro.rcp.layout.actions.Turn90DegreeRetargetAction;
...
public class MyGraphicalEditorActionBarContributor extends ActionBarContributor {
	...
	protected void buildActions() {
		...
		addRetargetAction(new Turn90DegreeRetargetAction());
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator());
		toolBarManager.add(getAction(Turn90DegreeAction.ID));
	}
