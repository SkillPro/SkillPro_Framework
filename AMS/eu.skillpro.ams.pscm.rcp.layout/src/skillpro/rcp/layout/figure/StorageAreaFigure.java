...
public class StorageAreaFigure extends Figure {
	private Label labelID = new Label();

	public static final int SA_FIGURE_DEFHEIGHT = 50;
	public static final int SA_FIGURE_DEFWIDTH = 100;

	public StorageAreaFigure() {
		setBackgroundColor(new Color(null, 210, 105, 30));
		...
		Path imageFilePath = new Path("icons/64x64/pause.png");
