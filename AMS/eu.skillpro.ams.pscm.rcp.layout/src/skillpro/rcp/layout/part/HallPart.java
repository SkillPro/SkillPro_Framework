...
import skillpro.rcp.layout.figure.HallFigure;
import skillpro.rcp.layout.model.GEFNode;
import skillpro.rcp.layout.model.Hall;

public class HallPart extends AppAbstractEditPart {
	@Override
	protected IFigure createFigure() {
		IFigure figure = new HallFigure();
		return figure;
	}
	...
	protected void refreshVisuals() {
		HallFigure figure = (HallFigure) getFigure();
