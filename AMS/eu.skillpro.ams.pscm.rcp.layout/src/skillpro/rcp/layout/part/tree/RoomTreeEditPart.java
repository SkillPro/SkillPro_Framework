...
public class RoomTreeEditPart extends AppAbstractTreeEditPart {
	@Override
	...
	public void propertyChange(PropertyChangeEvent evt) {
		...
		if (evt.getPropertyName().equals(GEFNode.PROPERTY_REMOVE))
			refreshChildren();
		if (evt.getPropertyName().equals(GEFNode.PROPERTY_XCOORD))
			refreshVisuals();
		if (evt.getPropertyName().equals(GEFNode.PROPERTY_YCOORD))
			refreshVisuals();
	}
}
