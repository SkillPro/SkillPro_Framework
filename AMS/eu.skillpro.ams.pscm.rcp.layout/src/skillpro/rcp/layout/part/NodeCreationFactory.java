...
public class NodeCreationFactory implements CreationFactory {
	...
	public Object getNewObject() {
		if (template == null)
			return null;
		if (template == Room.class) {
			Room room = new Room(new FactoryNode(""));
			room.setName("New Room");
			return room;
		} else if (template == GEFWorkingPlace.class) {
			GEFWorkingPlace wp = new GEFWorkingPlace(new Resource("", null,
					null));
			wp.setName("New WorkingPlace");
			return wp;
		}
		return null;
	}
