...
import skillpro.providers.skill.ExecutableSkillContentProvider;
import skillpro.providers.skill.ExecutableSkillLabelProvider;

public class ExecutableSkillTreeComposite extends TreeComposite {
	public ExecutableSkillTreeComposite(Composite parent, int style) {
		super(parent, style);
	...
	protected IContentProvider initContentProvider() {
		return new ExecutableSkillContentProvider();
	}
