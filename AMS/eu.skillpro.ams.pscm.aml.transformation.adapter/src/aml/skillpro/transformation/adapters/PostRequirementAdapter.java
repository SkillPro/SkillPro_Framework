...
public class PostRequirementAdapter extends RequirementAdapter implements IPostRequirementTransformable {
	public PostRequirementAdapter() {
		super();
	}
	
	public PostRequirementAdapter(Requirement requirement) {
		super(requirement);
	}
