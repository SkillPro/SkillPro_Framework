...
public class PreRequirementAdapter extends RequirementAdapter implements IPreRequirementTransformable {
	public PreRequirementAdapter() {
		super();
	}
	
	public PreRequirementAdapter(Requirement requirement) {
		super(requirement);
	}
