...
public class LoadMapping extends AbstractHandler implements IHandler {
	@Override
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		try {
			...
			System.out.println("Transformation Mapping loaded");
	...
	private void loadConfiguration() throws ValidityException, ParsingException, IOException {
		String filename = MasterFileDialog.getFilenameFromFileDialog(SupportedFileType.XML);
		if (filename != null && !filename.equals("")) {
			TransformationMappingParser.loadConfiguration(filename);
		}
	}
}
