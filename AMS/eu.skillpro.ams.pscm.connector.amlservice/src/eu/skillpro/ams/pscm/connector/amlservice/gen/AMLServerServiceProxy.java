...
public class AMLServerServiceProxy implements eu.skillpro.ams.pscm.connector.amlservice.gen.AMLServerService_PortType {
  private String _endpoint = null;
  private eu.skillpro.ams.pscm.connector.amlservice.gen.AMLServerService_PortType aMLServerService_PortType = null;
  ...
  private void _initAMLServerServiceProxy() {
    try {
      aMLServerService_PortType = (new eu.skillpro.ams.pscm.connector.amlservice.gen.AMLServerService_ServiceLocator()).getAMLServerServicePort();
  ...
  public eu.skillpro.ams.pscm.connector.amlservice.gen.AMLServerService_PortType getAMLServerService_PortType() {
    if (aMLServerService_PortType == null)
      _initAMLServerServiceProxy();
