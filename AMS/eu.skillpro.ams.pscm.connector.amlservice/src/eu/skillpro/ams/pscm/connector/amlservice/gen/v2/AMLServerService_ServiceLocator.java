...
public class AMLServerService_ServiceLocator extends org.apache.axis.client.Service implements eu.skillpro.ams.pscm.connector.amlservice.gen.v2.AMLServerService_Service {
    ...
    public eu.skillpro.ams.pscm.connector.amlservice.gen.v2.AMLServerService_PortType getAMLServerServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public eu.skillpro.ams.pscm.connector.amlservice.gen.v2.AMLServerService_PortType getAMLServerServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            eu.skillpro.ams.pscm.connector.amlservice.gen.v2.AMLServerServicePortBindingStub _stub = new eu.skillpro.ams.pscm.connector.amlservice.gen.v2.AMLServerServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (eu.skillpro.ams.pscm.connector.amlservice.gen.v2.AMLServerService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                eu.skillpro.ams.pscm.connector.amlservice.gen.v2.AMLServerServicePortBindingStub _stub = new eu.skillpro.ams.pscm.connector.amlservice.gen.v2.AMLServerServicePortBindingStub(new java.net.URL(AMLServerServicePort_address), this);
                _stub.setPortName(getAMLServerServicePortWSDDServiceName());
                return _stub;
            }
        }
