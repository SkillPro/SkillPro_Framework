...
package de.fzi.skillpro.order.commands;
...
import de.fzi.skillpro.order.perspectives.OrderPerspective;

public class OpenOrderPerspective extends AbstractHandler implements
		IHandler {
	public static final String ID = OpenOrderPerspective.class.getName();
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		IPerspectiveDescriptor pd = perspectiveRegistry.findPerspectiveWithId(OrderPerspective.ID);
