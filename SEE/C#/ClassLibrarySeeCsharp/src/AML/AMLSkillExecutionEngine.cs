...
{
    public class AMLSkillExecutionEngine
    {
        #region Fields

        private List<AMLResource> _resources = new List<AMLResource>();
        ...
        public CommType MESCommType { get; set; }
        public CommType AMSCommType { get; set; }
        public List<AMLResource> Resources { get { return _resources; } set { _resources = value; } }
